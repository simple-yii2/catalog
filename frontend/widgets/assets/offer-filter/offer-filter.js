$(function() {
	...
	$(document).on('click', '.offer-filter .filter-title', titleClick);
	$(document).on('change', '.offer-filter .filter-range .filter-controls input', rangeChange);
	$(document).on('change', '.offer-filter .filter-select .filter-controls input', selectChange);
