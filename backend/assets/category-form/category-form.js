$(function() {
    ...
    $(document).on('click', '.category-properties button.property-values', function() {
        var $this = $(this),
            $properties = $this.closest('.category-properties'),
            $modal = $('<div class="modal fade modal-properties" tabindex="-1" role="dialog"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><h3 class="modal-title"></h3></div><div class="modal-body"><table class="table table-condensed table-bordered"><colgroup><col></col><col style="width: 25px;"></col></colgroup><tbody></tbody></table></div><div class="modal-footer"><div class="pull-left"><button type="button" class="btn btn-default btn-modal-add"></button></div><button type="button" class="btn btn-primary btn-modal-ok"></button><button type="button" class="btn btn-default btn-modal-cancel" data-dismiss="modal"></button></div></div></div></div>'),
